...
async function buildPerformancePoint(report, days, priceCache) {
  ...
  const distanceToTarget = report.targetPrice - report.basePrice;
  const targetProgressPct = distanceToTarget === 0
    ? (closePrice >= report.targetPrice ? 100 : 0)
    : roundOne(((closePrice - report.basePrice) / distanceToTarget) * 100);
